...
## Все еще актуально 21.09.2026 (v18.10.1)

### AdbClearLog

Если в событии после сборки решения есть скрипт
```
set ADB_CLEAR_LOG=1
echo ADB_CLEAR_LOG: %ADB_CLEAR_LOG%
```
то его выполнение отобразит B_CLEAR_LOG вместо 1.
